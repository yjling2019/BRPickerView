Pod::Spec.new do |s|
  ...
  s.version      = "2.7.7"
  # 框架的简单介绍
  s.summary      = "A custom picker view for iOS. Fork from BRPickerView."
  # 框架的详细描述(详细介绍，要比简介长)
  s.description  = <<-DESC
                    A custom picker view for iOS, Include "日期选择器，时间选择器，地址选择器，自定义字符串选择器，支持自定义样式，适配深色模式", Support the Objective - C language.
                DESC
  # 框架的主页
  s.homepage     = "https://github.com/yjling2019/BRPickerView"
  # 证书类型
  ...
  # GitHub下载地址和版本
  s.source       = { :git => "https://github.com/yjling2019/BRPickerView.git", :tag => s.version.to_s }
  ...
  s.subspec 'DatePickerView' do |ss|
    ss.dependency 'KTPickerView/Base'
